...
<div class="mainNav clearfix">
		<ul class="Nav_ul">
			...
			<li><a href="${path }/route/routeList">旅游路线</a><img
				src="${path }/images/nav_line.jpg"></li>
			<li><a href="#">旅游景点</a><img
				src="${path }/images/nav_line.jpg"></li>
			<li><a href="#">餐饮住宿</a><img
				src="${path }/images/nav_line.jpg"></li>
			<li><a href="${path }/specialty/specialtyList">地方特产</a><img
				src="${path }/images/nav_line.jpg"></li>
			<li><a href="#">行程导航</a><img
				src="${path }/images/nav_line.jpg"></li>
			<li><a href="#">交通路线</a><img
				src="${path }/images/nav_line.jpg"></li>
			<li><a href="#">自动生成简介</a><img
				src="${path }/images/nav_line.jpg"></li>
			<li><a href="#">团队简介</a><img
				src="${path }/images/nav_line.jpg"></li>
			<li><a href="${path }/user/member">会员中心</a></li>
		</ul>
	</div>
        ...
        <div class="clumn_cl">
          ...
          <div class="df_wrap">
            ...
            <c:forEach items="${page2.datas }" var="spe">
              <dl>
                <dt><a href="${path}/specialty/specialtyDetail?id=${spe.id}"><img src="${path }/images/${spe.image}" style="width: 160px;height: 124px"></a></dt>
                <dd>
